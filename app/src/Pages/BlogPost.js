    ...
    <BlogPostConatainer>
      ...
      <div className="BlogPost-Comments">
        <div className="BlogPost-Comments-Top">
          <h2>Comments</h2>
          <Button color="#0071C2" >Comment</Button>
        </div>
        <CommentCard image={images[images.length - 1].url} comment="asldkfjasldkfjasldkjflasdkjflkjasdflkjaslkfdjasdlkfjasldkfjlasdkjflakjdsflasjdkflk laskjdflkasdfjl asdflkhasdfljhasdflkjhasd fjksdahf ajkdsfha sdlfjkhasdf kjahsdflkajsdf lkjasdfhlkasdfj hsadklfjdslafkj;lasdfk jal;skdfj ;lasfkj;as dlfkjasdf; lkjadsf;l kasjdf;lkas dfj;lkadsfj ;ladskfj ads;lfkjas ;dflkjasdf; lkjadsf;lkjadsf" name="Sanket Lamsal" />
        <CommentCard image={images[0].url} name="Subash Khatri" comment="asldkfjasldkfjasldkjflasdkjflkjasdflkjaslkfdjasdlkfjasldkfjlasdkjflakjdsflasjdkflk" replies={[{ userID: 12345, content: "You are so bad learn to speak english first :)" }, { userID: 32123, content: "Good Comment :)" }]} />
        <CommentCard image={images[0].url} name="Subash Khatri" comment="asldkfjasldkfjasldkjflasdkjflkjasdflkjaslkfdjasdlkfjasldkfjlasdkjflakjdsflasjdkflk" replies={[{ userID: 12345, content: "You are so bad learn to speak english first :)" }, { userID: 32123, content: "Good Comment :)" }, { userID: 32123, content: "The place was nice :P" }]} />
        <CommentCard
          image={images[1].url}
        ...
        />
        <CommentCard image={images[1].url} name="Pratham Bhattarai" comment="asldkfjasldkfjasldkjflasdkjflkjasdflkjaslkfdjasdlkfjasldkfjlasdkjflakjdsflasjdkflk" />
        <CommentCard comment="asldkfjasldkfjasldkjflasdkjflkjasdflkjaslkfdjasdlkfjasldkfjlasdkjflakjdsflasjdkflk" />
        <CommentCard comment="asldkfjasldkfjasldkjflasdkjflkjasdflkjaslkfdjasdlkfjasldkfjlasdkjflakjdsflasjdkflk" />
        <CommentCard comment="asldkfjasldkfjasldkjflasdkjflkjasdflkjaslkfdjasdlkfjasldkfjlasdkjflakjdsflasjdkflk" />
      </div>
    </BlogPostConatainer>
